...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'invoice-mgmt-system-2025-change-in-production')  # Change this in production

# Determine if running on Vercel
IS_VERCEL = os.environ.get('VERCEL', '0') == '1'
BASE_DIR = '/tmp' if IS_VERCEL else os.path.dirname(os.path.abspath(__file__))

# Initialize managers with Vercel-compatible paths
db_path = os.path.join(BASE_DIR, 'invoice_system.db') if IS_VERCEL else 'invoice_system.db'
...
def generate_invoice():
    ...
    try:
        ...
        invoices_dir = '/tmp/invoices' if IS_VERCEL else 'invoices'
...
def upload_csv():
    ...
    try:
        ...
        upload_path = os.path.join(uploads_dir, 'uploaded_data.csv')
